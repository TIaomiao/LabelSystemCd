...
| CMR-01 | Shared foundation | planned | `feat/cmr-01-result-contract` / worktree `cmr-01-result-contract` | baseline `f52a53d`; implementation verification pending | not scheduled |
